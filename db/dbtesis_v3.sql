...
--
-- Host: 127.0.0.1
-- Creato il: Apr 07, 2024 alle 23:11
...
--
-- Struttura della tabella `webgazer_data`
--

CREATE TABLE `webgazer_data` (
  `time` time(3) NOT NULL,
  `x` float NOT NULL,
  `y` float NOT NULL,
  `anonym_user_index` varchar(16) NOT NULL,
  `cod_page` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
--
-- Indici per le tabelle `webgazer_data`
--
ALTER TABLE `webgazer_data`
  ADD PRIMARY KEY (`time`,`anonym_user_index`),
  ADD KEY `data-page` (`cod_page`);
...
--
-- Limiti per la tabella `webgazer_data`
--
ALTER TABLE `webgazer_data`
  ADD CONSTRAINT `data-page` FOREIGN KEY (`cod_page`) REFERENCES `page` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
